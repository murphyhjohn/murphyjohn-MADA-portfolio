...
Shaun van den Hurk contributed to this exercise. 
...
@fig-weight-vo2max shows a scatterplot figure of Weight by VO2 Max.

```{r}
#| label: fig-weight-vo2max
#| fig-cap: "Weight by VO2 Max"
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Weight-VO2-Max-stratified.png"))
```

@fig-legume-height shows a scatterplot figure of Favorite Legume by Height.

```{r}
#| label: fig-legume-height
#| fig-cap: "Favorite Legume by Height"
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Favorite-legume-height-stratified.png"))
```

# New Table

@tbl-resulttable3 shows a summary of a linear model fit considering VO2 Max and Favorite Legume as predictors of Height.

```{r}
#| label: tbl-resulttable3
#| tbl-cap: "Linear model fit table: VO2 Max and Favorite Legume as predictors of Height."
#| echo: FALSE
